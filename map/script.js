...
class App {
    ...
    constructor() {
        ...
        containerWorkouts.addEventListener('click', this.#map._moveToPopup.bind(this))
        ...
        // add new obiect to workout array
      ...
      _newWorkout(workout) {
        ...
        if (workout.type === 'running')
            ...
            <span class="workout__value">${workout.pare}</span>
